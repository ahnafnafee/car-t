...
def manufacture(
    ...
    *,
    ...
    sterility, mycoplasma and appearance_ok are the boolean results behind the
    unredacted SBRA qualitative requirements; None keeps them unknown. Identity
    by CAR qPCR follows the manufactured CAR fraction (positive iff te > 0).
    ...
    assessment = assess_lot(
        {
            ...
            "identity_car_pcr_positive": te > 0,
